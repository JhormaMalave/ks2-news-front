<template>
    <div class="overflow-hidden rounded-xl bg-white shadow-md duration-200 hover:scale-105 hover:shadow-xl">
      ...
      <div class="p-5">
        <router-link :to="('articles/' + id)" class="text-gray-900 font-bold text-2xl tracking-tight mb-1 dark:text-white truncate hover:text-indigo-400">{{ title }}</router-link>
